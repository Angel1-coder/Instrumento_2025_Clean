"""
Django settings for Instrumento project.
...
WSGI_APPLICATION = 'Instrumento.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'instrumento-2025-bucket'  # change this to your AWS bucket name
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'noreply@instrumento.com'
